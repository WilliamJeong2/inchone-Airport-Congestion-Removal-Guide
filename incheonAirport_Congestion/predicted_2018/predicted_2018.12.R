...
#인러닝 값 대입
#2018년 12월 월요일~일요일 
in_learning_mon<-getDataSet(df_mon12$월요일,1,15,INPUT_NODES) #12월 값들 입력
in_learning_tue<-getDataSet(df_tue12$화요일,1,15,INPUT_NODES) #12월 값들 입력
in_learning_wed<-getDataSet(df_wed12$수요일,1,15,INPUT_NODES) #12월 값들 입력
in_learning_thu<-getDataSet(df_thu12$목요일,1,15,INPUT_NODES) #12월 값들 입력
in_learning_fri<-getDataSet(df_fri12$금요일,1,15,INPUT_NODES) #12월 값들 입력
in_learning_sat<-getDataSet(df_sat12$토요일,1,15,INPUT_NODES) #12월 값들 입력
in_learning_sun<-getDataSet(df_sun12$일요일,1,15,INPUT_NODES) #12월 값들 입력

#아웃러닝 값 대입
#2018년 12월 월요일~일요일
out_learning_mon<-getDataSet(df_mon12$월요일,3,16,OUTPUT_NODES) #12월 값들 출력
out_learning_tue<-getDataSet(df_tue12$화요일,3,16,OUTPUT_NODES) #12월 값들 출력
out_learning_wed<-getDataSet(df_wed12$수요일,3,16,OUTPUT_NODES) #12월 값들 출력
out_learning_thu<-getDataSet(df_thu12$목요일,3,16,OUTPUT_NODES) #12월 값들 출력
out_learning_fri<-getDataSet(df_fri12$금요일,3,16,OUTPUT_NODES) #12월 값들 출력
out_learning_sat<-getDataSet(df_sat12$토요일,3,16,OUTPUT_NODES) #12월 값들 출력
out_learning_sun<-getDataSet(df_sun12$일요일,3,16,OUTPUT_NODES) #12월 값들 출력

#신경망 모델 중 하나인 nnet 패키지 함수를 이용하여 12월~112월 이용자 수 예측값 모델링 설정
# 2018년 12월 월요일~일요일
...
in_forecasting_mon<-getDataSet(df_mon12$월요일,15,16,INPUT_NODES)
in_forecasting_tue<-getDataSet(df_tue12$화요일,15,16,INPUT_NODES)
in_forecasting_wed<-getDataSet(df_wed12$수요일,15,16,INPUT_NODES)
in_forecasting_thu<-getDataSet(df_thu12$목요일,15,16,INPUT_NODES)
in_forecasting_fri<-getDataSet(df_fri12$금요일,15,16,INPUT_NODES)
in_forecasting_sat<-getDataSet(df_sat12$토요일,15,16,INPUT_NODES)
in_forecasting_sun<-getDataSet(df_sun12$일요일,15,16,INPUT_NODES)

#1~12월 이용자 수 예측값 출력
#2018년 12월 월요일~일요일 예측값 출력
predicted_values_mon12<-predict(model_mon,in_forecasting_mon,type="raw")
predicted_values_tue12<-predict(model_tue,in_forecasting_tue,type="raw")
predicted_values_wed12<-predict(model_wed,in_forecasting_wed,type="raw")
predicted_values_thu12<-predict(model_thu,in_forecasting_thu,type="raw")
predicted_values_fri12<-predict(model_fri,in_forecasting_fri,type="raw")
predicted_values_sat12<-predict(model_sat,in_forecasting_sat,type="raw")
predicted_values_sun12<-predict(model_sun,in_forecasting_sun,type="raw")
